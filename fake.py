...
import pygame
import train as train  # Assuming this is another module you have
...
alert_sound = 'focus.mp3'
break_sound = 'take_a_break.mp3'
    ...
    if len(rects) > 0:
        ...
        if avgEAR < close_thresh:
            ...
            if yawn_countdown and flag >= frame_thresh_3:
                ...
                alert_sound = pygame.mixer.Sound('focus.mp3')
                alert_sound.play()
        ...
        if map_counter >= 3:
            map_flag = 1
            map_counter = 0
            break_sound = pygame.mixer.Sound('take_a_break.mp3')
            break_sound.play()
